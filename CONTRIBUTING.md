...
If it is a big feature, then [make an issue](https://github.com/MilkGames/rclone/issues) first so it can be discussed.

To prepare your pull request first press the fork button on [rclone's GitHub
page](https://github.com/MilkGames/rclone).
...
To base your changes on the latest version of the [rclone master](https://github.com/MilkGames/rclone/tree/master) (upstream):
...
rclone currently uses [GitHub Actions](https://github.com/MilkGames/rclone/actions) to build and test the project, which should be automatically available for your fork too from the `Actions` tab in your repository.
...
project root:
    ...
    go install github.com/MilkGames/rclone/fstest/test_all
...
[Go reference](https://godoc.org/github.com/MilkGames/rclone/lib/plugin)
